...
class ValidationPipeline:
    ...
    def __init__(self, xml_json_dir_path, xslt_dir_path, schema_dir_path, output_path):
        """
        ...
        for subcarpeta in os.listdir(self.xml_json_dir_path):
            ...
            if os.path.isdir(sub_dir):
                ...
                if path_json and path_xml:
                    ...
                    validacion = ValidacionProvisionales(path_xml, self.xslt_dir_path, path_json, self.schema_dir_path, self.output_path)
                    validacion.validar()
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(downloads_path(), "output_prueba")
    os.makedirs(output_path, exist_ok=True)

    # --- Ejecución del flujo completo ---
    pipeline = ValidationPadrones_prov(xml_json_dir_path, xslt_dir_path, schema_dir_path, output_path)
